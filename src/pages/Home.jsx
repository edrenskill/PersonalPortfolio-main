...
export const Home = () => {
  ...
  return (
    <section
      id="home"
      className="xl:h-screen sm:py-20 bg-slate-50 flex items-center justify-center"
    >
      <div className="m-auto sm:w-[90%] md:w-[60%] flex sm:flex-col-reverse xl:flex-row gap-5">
        <motion.div>
          ...
          <div className="mt-6 flex items-center sm:justify-center xl:justify-start ">
            <a
              className=""
              href="https://www.linkedin.com/in/edren-cabonegro-556317253/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              className=""
              href="https://www.facebook.com/blackman1994/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              className=""
              href="https://www.youtube.com/@edrenskill/"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <div className="teck-stack  flex sm:flex-col xl:flex-row items-center justify-between gap-2 xl:mt-0 sm:mt-10 ">
            ...
            <div className="tech-icons  transition grid sm:grid-cols-3 content-center justify-content-center xl:grid-cols-6 gap-5 xl:mt-0 sm:mt-0">
              ...
              >
                <img
                  className="w-full h-full object-cover"
                  src="/images/icons8-mysql-80.png"
                  alt="WordPress"
                />
              </motion.div>
            </div>
